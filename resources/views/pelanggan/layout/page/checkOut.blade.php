            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body pembayaran">
                        ...
                        {{-- <div class="row mb-3">
                            <label for="diskon" class="col-form-label col-sm-6">Discount</label>
                            <div class="col-sm-6">
                                @if (Auth::user())
                                    <input type="number" class="form-control discount" id="diskon" name="diskon"
                                        value="0">
                                @else
                                    <input type="number" class="form-control discount" id="diskon" name="diskon"
                                        value="0">
                        ...
                        <hr>
                        {{-- <div class="row mb-3">
                            <label for="dibayar" class="col-form-label col-sm-6">Total</label>
                            <div class="col-sm-6">
                                <input type="number" class="form-control dibayarkan" id="dibayar" name="dibayar"
                                    value="0" readonly>
                            </div>
                        </div> --}}
                        <div class="row mb-3">
